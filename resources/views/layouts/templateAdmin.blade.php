            ...
            <nav class="navbar-mobile">
                <div class="container-fluid">
                    <ul class="navbar-mobile__list list-unstyled">
                        ...
                        <li>
                            <a href="{{ route('booksAdmin') }}"><i class="fas fa-book"></i>Book</a>
                        </li>
                        <li>
                            <a href="{{ route('authorsAdmin') }}">
                        ...
                        <li>
                            <a href="{{ route('publishersAdmin') }}"><i class="fas fa-building"></i>Publishers</a>
                        </li>
                        <li>
                            <a href="{{ route('borrowAdmin') }}"><i class="fas fa-clipboard"></i>Borrow Book List</a>
                        </li>
                        <li>
                            <a href="{{ route('profileAdmin') }}"><i class="fas fa-user"></i>Profile</a>
                        </li>
                                        ...
                                        <div class="image">
                                            ...
                                            @if (auth()->user()->image != null)
                                                <img src="{{ asset('storage/' . auth()->user()->image) }}"
                                                    style="max-height: 300px" alt="{{ auth()->user()->image }}" />
                                            @else
